let billAmount = 92.57
function gratuity (originalBill) {
    return originalBill*.2
};

function totalWithGrat (originalBill) {
    return (originalBill+gratuity (originalBill)).toFixed(2)
};
